...
### 1. Real interview question: How would you explain 'Vectors, matrices, and transformations' to a PM in under one minute?
Model answer:
"I present Vectors, matrices, and transformations as a decision workflow for inflation and policy-rate repricing. Step one: define notation, units, and assumptions clearly. Step two: show one numeric result on a real ticker and state its decision impact. Step three: enforce a guardrail (cap gross exposure and re-check compounding assumptions) and explain the fallback path if it fails. For implementation, I would implement matrix operations and shape checks using NumPy."
### 2. Real interview question: How would you explain 'Eigenvalues, eigenvectors, and PCA intuition' to a PM in under one minute?
Model answer:
"I present Eigenvalues, eigenvectors, and PCA intuition as a decision workflow for inflation and policy-rate repricing. Step one: define notation, units, and assumptions clearly. Step two: show one numeric result on a real ticker and state its decision impact. Step three: enforce a guardrail (cap gross exposure and re-check compounding assumptions) and explain the fallback path if it fails. For implementation, I would build PCA diagnostic plots and explained-variance table."
### 3. Real interview question: How would you explain 'Optimization fundamentals' to a PM in under one minute?
Model answer:
"I present Optimization fundamentals as a decision workflow for inflation and policy-rate repricing. Step one: define notation, units, and assumptions clearly. Step two: show one numeric result on a real ticker and state its decision impact. Step three: enforce a guardrail (cap gross exposure and re-check compounding assumptions) and explain the fallback path if it fails. For implementation, I would code constrained optimization with objective logging."
### 4. Real interview question: How would you explain 'Pandas data engineering workflow' to a PM in under one minute?
Model answer:
"I present Pandas data engineering workflow as a decision workflow for inflation and policy-rate repricing. Step one: define notation, units, and assumptions clearly. Step two: show one numeric result on a real ticker and state its decision impact. Step three: enforce a guardrail (cap gross exposure and re-check compounding assumptions) and explain the fallback path if it fails. For implementation, I would create a reusable data cleaning pipeline function."
### 5. Real interview question: How would you explain 'SQL basics for quant datasets' to a PM in under one minute?
Model answer:
"I present SQL basics for quant datasets as a decision workflow for inflation and policy-rate repricing. Step one: define notation, units, and assumptions clearly. Step two: show one numeric result on a real ticker and state its decision impact. Step three: enforce a guardrail (cap gross exposure and re-check compounding assumptions) and explain the fallback path if it fails. For implementation, I would write SQL queries for instrument-level and portfolio-level summaries."
