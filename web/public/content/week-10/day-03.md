...
1. PM interview question (Week 10 Day 03): Explain AR(1) and define every symbol clearly.
...
3. Production question: Why does 'GARCH intuition' matter in live trading systems?
   - Model answer: "GARCH intuition matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through GARCH intuition as if you are presenting to a PM who cares about risk-adjusted returns."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 10 Day 03 to prove notation fluency.
