...
Given:
- Strategy annualized volatility estimate is 0.182.
...
2. raw_scale = 0.20/0.182 = 1.0989.
3. clipped_scale = min(1.00, max(0.20, 1.0989)) = 1.0000.
...
1. PM interview question (Week 10 Day 02): Explain Autocorrelation and define every symbol clearly.
...
3. Production question: Why does 'EWMA volatility estimation' matter in live trading systems?
   - Model answer: "EWMA volatility estimation matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through EWMA volatility estimation as if you are presenting to a PM who cares about risk-adjusted returns."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 10 Day 02 to prove notation fluency.
