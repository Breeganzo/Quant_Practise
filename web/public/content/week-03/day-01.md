...
Vector space intuition should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Matrix multiplication in factor exposure
Matrix multiplication in factor exposure should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Linear transformations for feature pipelines
Linear transformations for feature pipelines should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
