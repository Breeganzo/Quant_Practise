...
Objective functions and constraints should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Constrained optimization in portfolios
Constrained optimization in portfolios should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Regularization and numerical stability
Regularization and numerical stability should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
