...
Index alignment and time-aware joins should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Groupby/rolling windows
Groupby/rolling windows should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Missing data treatment strategies
Missing data treatment strategies should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
