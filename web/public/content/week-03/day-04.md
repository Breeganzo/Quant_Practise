...
Given:
- Strategy annualized volatility estimate is 0.170.
...
2. raw_scale = 0.20/0.170 = 1.1765.
3. clipped_scale = min(1.00, max(0.20, 1.1765)) = 1.0000.
...
1. PM interview question (Week 03 Day 04): Explain Sharpe Ratio and define every symbol clearly.
...
3. Production question: Why does 'Pandas data engineering workflow' matter in live trading systems?
   - Model answer: "Pandas data engineering workflow matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 03 Day 04 to prove notation fluency.
