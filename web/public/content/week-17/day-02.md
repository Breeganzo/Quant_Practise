...
1. PM interview question (Week 17 Day 02): Explain Information Coefficient and define every symbol clearly.
...
3. Production question: Why does 'Cross-sectional regressions' matter in live trading systems?
   - Model answer: "Cross-sectional regressions matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 17 Day 02 to prove notation fluency.
