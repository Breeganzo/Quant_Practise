...
Given:
- Strategy annualized volatility estimate is 0.202.
...
2. raw_scale = 0.20/0.202 = 0.9901.
3. clipped_scale = min(1.00, max(0.20, 0.9901)) = 0.9901.
Final answer: Position multiplier = 0.9901.
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 19 Day 04 to prove notation fluency.
