...
1. PM interview question (Week 09 Day 05): Explain RMSE and define every symbol clearly.
...
3. Production question: Why does 'Forecast evaluation and communication' matter in live trading systems?
   - Model answer: "Forecast evaluation and communication matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through Forecast evaluation and communication as if you are presenting to a PM who cares about risk-adjusted returns."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 09 Day 05 to prove notation fluency.
