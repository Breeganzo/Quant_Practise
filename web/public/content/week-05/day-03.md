...
Log-odds and probabilities should be treated as a measurable component of 'Supervised ML I: regression and classification'. For this week, emphasize causal feature design, leakage control, and robust model validation. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Decision thresholds
Decision thresholds should be treated as a measurable component of 'Supervised ML I: regression and classification'. For this week, emphasize causal feature design, leakage control, and robust model validation. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Class imbalance effects
Class imbalance effects should be treated as a measurable component of 'Supervised ML I: regression and classification'. For this week, emphasize causal feature design, leakage control, and robust model validation. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
