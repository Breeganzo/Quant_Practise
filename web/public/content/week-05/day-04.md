...
MAE/RMSE for regression should be treated as a measurable component of 'Supervised ML I: regression and classification'. For this week, emphasize causal feature design, leakage control, and robust model validation. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Precision, recall, F1, AUC for classification
Precision, recall, F1, AUC for classification should be treated as a measurable component of 'Supervised ML I: regression and classification'. For this week, emphasize causal feature design, leakage control, and robust model validation. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Economic utility versus statistical metrics
Economic utility versus statistical metrics should be treated as a measurable component of 'Supervised ML I: regression and classification'. For this week, emphasize causal feature design, leakage control, and robust model validation. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
