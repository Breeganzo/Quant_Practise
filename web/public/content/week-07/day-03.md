...
1. PM interview question (Week 07 Day 03): Explain MSE and define every symbol clearly for a post-earnings momentum regime where feature drift is elevated.
...
4. Production question: Why does 'PCA for regime and factor hints' matter in live trading systems?
   - Model answer: "PCA for regime and factor hints matters because model decisions fail quickly without leakage controls, drift monitoring, and threshold governance. In production I need reproducible calculations, explicit control limits, and escalation rules that survive stress windows."
...
### Interview Drill
- Prompt: "Walk me through PCA for regime and factor hints in a model-risk review after prediction drift and weaker precision."
