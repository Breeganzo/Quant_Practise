...
Parallel and non-parallel shifts should be treated as a measurable component of 'Fixed income basics for quant workflows'. For this week, emphasize allocation constraints, risk decomposition, and capital efficiency. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Curve-bucket exposures
Curve-bucket exposures should be treated as a measurable component of 'Fixed income basics for quant workflows'. For this week, emphasize allocation constraints, risk decomposition, and capital efficiency. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Stress scenario design
Stress scenario design should be treated as a measurable component of 'Fixed income basics for quant workflows'. For this week, emphasize allocation constraints, risk decomposition, and capital efficiency. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
