...
Macaulay and modified duration should be treated as a measurable component of 'Fixed income basics for quant workflows'. For this week, emphasize allocation constraints, risk decomposition, and capital efficiency. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: First-order rate sensitivity
First-order rate sensitivity should be treated as a measurable component of 'Fixed income basics for quant workflows'. For this week, emphasize allocation constraints, risk decomposition, and capital efficiency. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Convexity correction
Convexity correction should be treated as a measurable component of 'Fixed income basics for quant workflows'. For this week, emphasize allocation constraints, risk decomposition, and capital efficiency. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
