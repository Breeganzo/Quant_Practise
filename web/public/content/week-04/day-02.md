...
1. PM interview question (Week 04 Day 02): Explain Log Return and define every symbol clearly.
...
3. Production question: Why does 'Risk distribution diagnostics' matter in live trading systems?
   - Model answer: "Risk distribution diagnostics matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 04 Day 02 to prove notation fluency.
