...
1. PM interview question (Week 02 Day 05): Explain Turnover and define every symbol clearly for an inflation surprise week with simultaneous equity and rate volatility.
...
4. Production question: Why does 'Statistical communication for finance decisions' matter in live trading systems?
   - Model answer: "Statistical communication for finance decisions matters because reliable notation and units prevent silent compounding and scaling errors in production PnL reporting. In production I need reproducible calculations, explicit control limits, and escalation rules that survive stress windows."
...
### Interview Drill
- Prompt: "Walk me through Statistical communication for finance decisions in a PM review after CPI surprise where benchmark drawdown accelerated."
