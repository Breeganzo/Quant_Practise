...
Fixed and proportional costs should be treated as a measurable component of 'Backtesting architecture and implementation realism'. For this week, emphasize temporal dependence structure and out-of-sample forecast discipline. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Spread and impact proxies
Spread and impact proxies should be treated as a measurable component of 'Backtesting architecture and implementation realism'. For this week, emphasize temporal dependence structure and out-of-sample forecast discipline. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Turnover sensitivity
Turnover sensitivity should be treated as a measurable component of 'Backtesting architecture and implementation realism'. For this week, emphasize temporal dependence structure and out-of-sample forecast discipline. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
