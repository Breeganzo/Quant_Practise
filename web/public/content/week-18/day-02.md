...
1. PM interview question (Week 18 Day 02): Explain Information Coefficient and define every symbol clearly.
...
3. Production question: Why does 'Cointegration basics' matter in live trading systems?
   - Model answer: "Cointegration basics matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through Cointegration basics as if you are presenting to a PM who cares about risk-adjusted returns."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 18 Day 02 to prove notation fluency.
