...
Skewness and kurtosis in return data should be treated as a measurable component of 'Return/risk analytics and exploratory capstone'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
...
Downside-focused metrics should be treated as a measurable component of 'Return/risk analytics and exploratory capstone'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
