...
1. PM interview question (Week 01 Day 01): Explain Simple Return and define every symbol clearly for an inflation surprise week with simultaneous equity and rate volatility.
...
4. Production question: Why does 'Environment reproducibility and data loading' matter in live trading systems?
   - Model answer: "Environment reproducibility and data loading matters because reliable notation and units prevent silent compounding and scaling errors in production PnL reporting. In production I need reproducible calculations, explicit control limits, and escalation rules that survive stress windows."
...
### Interview Drill
- Prompt: "Walk me through Environment reproducibility and data loading in a PM review after CPI surprise where benchmark drawdown accelerated."
