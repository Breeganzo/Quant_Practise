...
Given:
- Strategy annualized volatility estimate is 0.165.
...
2. raw_scale = 0.20/0.165 = 1.2121.
3. clipped_scale = min(1.00, max(0.20, 1.2121)) = 1.0000.
...
1. PM interview question (Week 01 Day 03): Explain Annualized Volatility and define every symbol clearly.
...
3. Production question: Why does 'Calculus intuition for optimization' matter in live trading systems?
   - Model answer: "Calculus intuition for optimization matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through Calculus intuition for optimization as if you are presenting to a PM who cares about risk-adjusted returns."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 01 Day 03 to prove notation fluency.
