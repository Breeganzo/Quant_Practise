...
1. PM interview question (Week 01 Day 03): Explain Annualized Volatility and define every symbol clearly for an inflation surprise week with simultaneous equity and rate volatility.
   - Model answer: "I use Annualized Volatility as a decision bridge from market observations to position sizing. The formula is $\sigma_{ann}=\sqrt{252}\,Std(r_t)$. I define each symbol with units first, then compute one concrete value, and finally state what trade action changes because of the result in this regime."
...
4. Production question: Why does 'Calculus intuition for optimization' matter in live trading systems?
   - Model answer: "Calculus intuition for optimization matters because reliable notation and units prevent silent compounding and scaling errors in production PnL reporting. In production I need reproducible calculations, explicit control limits, and escalation rules that survive stress windows."
...
### Interview Drill
- Prompt: "Walk me through Calculus intuition for optimization in a PM review after CPI surprise where benchmark drawdown accelerated."
