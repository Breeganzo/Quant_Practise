...
Given:
- Strategy annualized volatility estimate is 0.173.
...
2. raw_scale = 0.20/0.173 = 1.1561.
3. clipped_scale = min(1.00, max(0.20, 1.1561)) = 1.0000.
...
1. PM interview question (Week 06 Day 01): Explain Forward Target and define every symbol clearly.
...
3. Production question: Why does 'Decision trees and feature interactions' matter in live trading systems?
   - Model answer: "Decision trees and feature interactions matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through Decision trees and feature interactions as if you are presenting to a PM who cares about risk-adjusted returns."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 06 Day 01 to prove notation fluency.
