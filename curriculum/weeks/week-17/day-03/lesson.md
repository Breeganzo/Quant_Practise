...
Given:
- Strategy annualized volatility estimate is 0.197.
...
2. raw_scale = 0.20/0.197 = 1.0152.
3. clipped_scale = min(1.00, max(0.20, 1.0152)) = 1.0000.
...
1. PM interview question (Week 17 Day 03): Explain IC t-Statistic and define every symbol clearly.
...
3. Production question: Why does 'Information coefficient and decay' matter in live trading systems?
   - Model answer: "Information coefficient and decay matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through Information coefficient and decay as if you are presenting to a PM who cares about risk-adjusted returns."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 17 Day 03 to prove notation fluency.
