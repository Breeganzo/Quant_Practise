...
Given:
- Strategy annualized volatility estimate is 0.198.
...
2. raw_scale = 0.20/0.198 = 1.0101.
3. clipped_scale = min(1.00, max(0.20, 1.0101)) = 1.0000.
...
1. PM interview question (Week 17 Day 04): Explain Spread Z-Score and define every symbol clearly.
...
3. Production question: Why does 'Portfolio construction for factors' matter in live trading systems?
   - Model answer: "Portfolio construction for factors matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through Portfolio construction for factors as if you are presenting to a PM who cares about risk-adjusted returns."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 17 Day 04 to prove notation fluency.
