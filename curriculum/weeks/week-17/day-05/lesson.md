...
1. PM interview question (Week 17 Day 05): Explain Implementation Shortfall and define every symbol clearly.
...
3. Production question: Why does 'Factor robustness' matter in live trading systems?
   - Model answer: "Factor robustness matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through Factor robustness as if you are presenting to a PM who cares about risk-adjusted returns."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 17 Day 05 to prove notation fluency.
