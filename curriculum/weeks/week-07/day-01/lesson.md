...
1. PM interview question (Week 07 Day 01): Explain Forward Target and define every symbol clearly for a post-earnings momentum regime where feature drift is elevated.
...
3. Production question: Why does 'Unsupervised problem framing' matter in live trading systems?
   - Model answer: "Unsupervised problem framing matters because model decisions fail quickly without leakage controls, drift monitoring, and threshold governance. In production I need reproducible calculations, explicit control limits, and escalation rules that survive stress windows."

Scoring rubric:
- Full credit requires: correct notation, one numeric example, one explicit risk guardrail, and one production escalation rule.

### Interview Drill
- Prompt: "Walk me through Unsupervised problem framing in a model-risk review after prediction drift and weaker precision."
