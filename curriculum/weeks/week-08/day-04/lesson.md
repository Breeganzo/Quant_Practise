...
1. PM interview question (Week 08 Day 04): Explain Cross-Entropy and define every symbol clearly for a post-earnings momentum regime where feature drift is elevated.
...
4. Production question: Why does 'Explainability and model governance' matter in live trading systems?
   - Model answer: "Explainability and model governance matters because model decisions fail quickly without leakage controls, drift monitoring, and threshold governance. In production I need reproducible calculations, explicit control limits, and escalation rules that survive stress windows."
...
### Interview Drill
- Prompt: "Walk me through Explainability and model governance in a model-risk review after prediction drift and weaker precision."
