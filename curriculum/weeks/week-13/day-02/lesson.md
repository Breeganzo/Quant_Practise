...
1. PM interview question (Week 13 Day 02): Explain Portfolio Variance and define every symbol clearly for a cross-asset drawdown week with correlation spikes.
...
4. Production question: Why does 'Mean-variance optimization' matter in live trading systems?
   - Model answer: "Mean-variance optimization matters because portfolio choices are constrained by covariance instability, transaction costs, and risk budgets. In production I need reproducible calculations, explicit control limits, and escalation rules that survive stress windows."
...
### Interview Drill
- Prompt: "Walk me through Mean-variance optimization in an investment committee session after correlation breakdown."
