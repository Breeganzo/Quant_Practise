...
Relational schema design should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Filtering, aggregation, and joins
Filtering, aggregation, and joins should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Time-series query patterns
Time-series query patterns should be treated as a measurable component of 'Linear algebra, optimization, and data engineering'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
