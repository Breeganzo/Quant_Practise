...
1. PM interview question (Week 03 Day 03): Explain Annualized Volatility and define every symbol clearly.
...
3. Production question: Why does 'Optimization fundamentals' matter in live trading systems?
   - Model answer: "Optimization fundamentals matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 03 Day 03 to prove notation fluency.
