...
## Questions
1. Explain the practical purpose of 'Risk framework architecture' in quant workflows.
2. Explain the practical purpose of 'VaR approaches' in quant workflows.
3. Explain the practical purpose of 'CVaR and tail focus' in quant workflows.
4. Explain the practical purpose of 'Stress testing framework' in quant workflows.
5. Explain the practical purpose of 'Risk governance reporting' in quant workflows.
