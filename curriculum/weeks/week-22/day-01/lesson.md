...
1. PM interview question (Week 22 Day 01): Explain Expected Value and define every symbol clearly for a live-paper trading month with strict risk committee oversight.
...
4. Production question: Why does 'Probability drill framework' matter in live trading systems?
   - Model answer: "Probability drill framework matters because deployment decisions must combine edge estimates with operational and risk controls. In production I need reproducible calculations, explicit control limits, and escalation rules that survive stress windows."
...
### Interview Drill
- Prompt: "Walk me through Probability drill framework in a launch readiness panel before promoting from paper-trade."
