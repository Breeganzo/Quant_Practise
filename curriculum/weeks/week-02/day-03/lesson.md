...
Population vs sample should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Estimator bias and variance tradeoff
Estimator bias and variance tradeoff should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Central limit theorem intuition
Central limit theorem intuition should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
