...
Effect size versus significance should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Practical significance under costs
Practical significance under costs should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Decision thresholds under uncertainty
Decision thresholds under uncertainty should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
