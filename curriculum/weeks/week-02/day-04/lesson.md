...
Confidence intervals for means should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Null/alternative hypotheses
Null/alternative hypotheses should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: P-value interpretation pitfalls
P-value interpretation pitfalls should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
