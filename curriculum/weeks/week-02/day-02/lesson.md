...
Expected value as long-run average should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Variance as uncertainty proxy
Variance as uncertainty proxy should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Covariance/correlation for co-movement
Covariance/correlation for co-movement should be treated as a measurable component of 'Probability and statistics for market data'. For this week, emphasize clean data assumptions and stable mathematical transformations. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
