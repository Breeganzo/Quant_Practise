...
Feature-target definition should be treated as a measurable component of 'Supervised ML I: regression and classification'. For this week, emphasize causal feature design, leakage control, and robust model validation. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Temporal train/validation/test splitting
Temporal train/validation/test splitting should be treated as a measurable component of 'Supervised ML I: regression and classification'. For this week, emphasize causal feature design, leakage control, and robust model validation. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Data leakage taxonomy
Data leakage taxonomy should be treated as a measurable component of 'Supervised ML I: regression and classification'. For this week, emphasize causal feature design, leakage control, and robust model validation. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
