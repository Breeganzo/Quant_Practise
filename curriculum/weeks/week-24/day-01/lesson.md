...
1. PM interview question (Week 24 Day 01): Explain Expected Value and define every symbol clearly.
...
3. Production question: Why does 'Portfolio curation and selection' matter in live trading systems?
   - Model answer: "Portfolio curation and selection matters because it links model logic to real execution constraints. In production, I need reproducible calculations, explicit guardrails, and decision rules that stay stable when regime conditions change."
...
### Interview Drill
- Prompt: "Walk me through Portfolio curation and selection as if you are presenting to a PM who cares about risk-adjusted returns."
