...
Given:
- Strategy annualized volatility estimate is 0.199.
...
2. raw_scale = 0.20/0.199 = 1.0050.
3. clipped_scale = min(1.00, max(0.20, 1.0050)) = 1.0000.
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 19 Day 01 to prove notation fluency.
