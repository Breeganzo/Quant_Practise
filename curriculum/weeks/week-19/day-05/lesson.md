...
Given:
- Strategy annualized volatility estimate is 0.203.
...
2. raw_scale = 0.20/0.203 = 0.9852.
3. clipped_scale = min(1.00, max(0.20, 0.9852)) = 0.9852.
Final answer: Position multiplier = 0.9852.
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 19 Day 05 to prove notation fluency.
