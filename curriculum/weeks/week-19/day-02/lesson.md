...
Given:
- Strategy annualized volatility estimate is 0.200.
...
2. raw_scale = 0.20/0.200 = 1.0000.
3. clipped_scale = min(1.00, max(0.20, 1.0000)) = 1.0000.
...
- **Extension Block C (30 min):** Interview simulation and review.
  ...
  - Include one numeric example from Week 19 Day 02 to prove notation fluency.
