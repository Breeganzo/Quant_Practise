...
Coupon and principal cashflows should be treated as a measurable component of 'Fixed income basics for quant workflows'. For this week, emphasize allocation constraints, risk decomposition, and capital efficiency. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 2: Yield-to-maturity intuition
Yield-to-maturity intuition should be treated as a measurable component of 'Fixed income basics for quant workflows'. For this week, emphasize allocation constraints, risk decomposition, and capital efficiency. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.

### Concept 3: Price-yield inverse relation
Price-yield inverse relation should be treated as a measurable component of 'Fixed income basics for quant workflows'. For this week, emphasize allocation constraints, risk decomposition, and capital efficiency. State the formula, verify units, test edge cases, and explain exactly how market regime shifts could break the assumption.
